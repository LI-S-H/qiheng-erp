...
VALUES
  ...
  (1900000000000001002, 'PURCHASE_STAFF', '采购员', '["product:query", "warehouse:query", "supplier:query", "supplier:create", "purchase:query", "purchase:create", "purchase:manage"]', 1, '2026-06-05 20:35:00', '2026-07-16 10:00:00', 0, '负责供应商维护和采购订单操作', 0),
  (1900000000000001003, 'SALES_STAFF', '销售员', '["product:query", "warehouse:query", "customer:query", "customer:create", "sales:query", "sales:create", "sales:manage"]', 1, '2026-06-05 20:36:00', '2026-07-16 10:00:00', 0, '负责客户维护和销售订单操作', 0),
  (1900000000000001004, 'WAREHOUSE_STAFF', '仓管员', '["product:query", "warehouse:query", "warehouse:manage"]', 1, '2026-06-05 20:37:00', '2026-06-27 14:06:10', 0, '负责仓库管理、出入库和库存调整', 4),
  (1900000000000001005, 'BUSINESS_MANAGER', '业务主管', '["product:query", "product:manage", "warehouse:query", "warehouse:manage", "supplier:query", "supplier:create", "purchase:query", "purchase:create", "purchase:manage", "customer:query", "customer:create", "sales:query", "sales:create", "sales:manage", "ai:query:stock", "ai:query:sales", "ai:query:purchase", "ai:ops:suggest"]', 1, '2026-06-05 20:38:00', '2026-07-16 10:00:00', 0, '查看全链路业务数据和AI分析建议', 0),
  (1900000000000001006, 'AI_ANALYST', 'AI分析师', '["product:query", "warehouse:query", "supplier:query", "purchase:query", "customer:query", "sales:query", "ai:query:stock", "ai:query:sales", "ai:query:purchase", "ai:ops:suggest", "ai:decision:suggest"]', 1, '2026-06-05 20:39:00', '2026-07-03 17:00:43', 0, '仅查询业务数据和AI问答，当前停用', 0);
