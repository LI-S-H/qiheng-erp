...
CREATE TABLE IF NOT EXISTS customer (
    ...
    credit_limit BIGINT NOT NULL DEFAULT 0 COMMENT '信用额度，放大100倍保存，18000000表示180000.00',
...
CREATE TABLE IF NOT EXISTS sales_order (
    ...
    total_amount BIGINT NOT NULL DEFAULT 0 COMMENT '订单总金额，放大100倍保存，0表示0.00',
...
CREATE TABLE IF NOT EXISTS sales_order_item (
    ...
    unit_price BIGINT NOT NULL DEFAULT 0 COMMENT '销售单价，放大100倍保存，0表示0.00',
    total_amount BIGINT NOT NULL DEFAULT 0 COMMENT '明细金额，放大100倍保存，0表示0.00',
    create_time DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间',
    update_time DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '更新时间',
    remark VARCHAR(500) NOT NULL DEFAULT '' COMMENT '备注',
    version INT NOT NULL DEFAULT 0 COMMENT '乐观锁版本号',
