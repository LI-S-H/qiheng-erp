...
const mockOverview: DashboardOverview = {
  ...
  todos: [
    ...
    { todoId: 'todo-stock-risk-review', businessType: 'INVENTORY', businessLabel: '库存', title: '库存异常待复核', description: '还有 8 个 SKU 可用库存低于安全线或已无可用库存，需要复核补货或调拨。', count: 8, priority: 'HIGH', sortWeight: 30, sourceMode: 'AGGREGATED', completionMode: 'AUTO', status: 'PENDING', errorCode: null, errorMessage: null, sourceNo: null, occurredAt: null, resolveHint: '前往库存余额查看低库存 SKU，补货计划生成或库存恢复后自动更新。', evidence: [
      { itemId: 'stock-P000013-W008', primaryText: 'USB-C扩展坞（P000013）', secondaryText: '南京备货仓 · 可用库存为 0，已影响销售出库', metrics: [{ label: '可用', value: '0 个', tone: 'risk' }, { label: '安全线', value: '4 个', tone: 'neutral' }, { label: '建议补货', value: '8 个', tone: 'risk' }] },
      { itemId: 'stock-P000008-W002', primaryText: '热敏标签纸（P000008）', secondaryText: '华南中心仓 · 当前无可用库存，需补货或调拨', metrics: [{ label: '可用', value: '0 卷', tone: 'risk' }, { label: '安全线', value: '40 卷', tone: 'neutral' }, { label: '建议补货', value: '40 卷', tone: 'risk' }] },
    ...
    { todoId: 'todo-price-review', businessType: 'PURCHASE', businessLabel: '采购', title: '采购价偏离参考价', description: '有 2 个产品最近采购价高于产品参考采购价，需要确认是临时涨价还是需要调整参考价。', count: 2, priority: 'MEDIUM', sortWeight: 60, sourceMode: 'AGGREGATED', completionMode: 'AUTO', status: 'PENDING', errorCode: null, errorMessage: null, sourceNo: null, occurredAt: null, resolveHint: '前往供货产品或采购订单核对供应商报价；如确认为长期价格变化，再维护产品参考采购价。', evidence: [
      { itemId: 'price-P000013', primaryText: 'USB-C扩展坞（P000013）', secondaryText: '拓联数码配件 · 供货产品 TL-HUB8', metrics: [{ label: '参考采购价', value: '￥126.00', tone: 'neutral' }, { label: '最近采购价', value: '￥148.80', tone: 'risk' }, { label: '偏离', value: '+18.1%', tone: 'risk' }] },
      { itemId: 'price-P000005', primaryText: '中性签字笔（P000005）', secondaryText: '文仪办公渠道 · PO202606006', metrics: [{ label: '参考采购价', value: '￥12.50', tone: 'neutral' }, { label: '最近采购价', value: '￥13.80', tone: 'watch' }, { label: '偏离', value: '+10.4%', tone: 'watch' }] },
  ...
  stockAlerts: [
    { stockId: '1940000000000000015', productId: '1920000000000000013', productCode: 'P000013', productName: 'USB-C扩展坞', warehouseId: '1930000000000000008', warehouseName: '南京备货仓', unitName: '个', availableQty: 0, safetyStockQty: 4, suggestedPurchaseQty: 8, severity: 'HIGH', latestOutboundAt: '2026-06-13 11:55:00' },
    { stockId: '1940000000000000006', productId: '1920000000000000008', productCode: 'P000008', productName: '热敏标签纸', warehouseId: '1930000000000000002', warehouseName: '华南中心仓', unitName: '卷', availableQty: 0, safetyStockQty: 40, suggestedPurchaseQty: 40, severity: 'HIGH', latestOutboundAt: '2026-06-14 08:40:00' },
    { stockId: '1940000000000000014', productId: '1920000000000000014', productCode: 'P000014', productName: '无线办公鼠标', warehouseId: '1930000000000000007', warehouseName: '杭州电商仓', unitName: '个', availableQty: 0, safetyStockQty: 8, suggestedPurchaseQty: 12, severity: 'HIGH', latestOutboundAt: '2026-06-13 13:10:00' },
    { stockId: '1940000000000000002', productId: '1920000000000000002', productCode: 'P000002', productName: '速溶黑咖啡', warehouseId: '1930000000000000001', warehouseName: '华东中心仓', unitName: '盒', availableQty: 5, safetyStockQty: 8, suggestedPurchaseQty: 12, severity: 'MEDIUM', latestOutboundAt: '2026-06-14 09:18:00' },
    { stockId: '1940000000000000005', productId: '1920000000000000007', productCode: 'P000007', productName: 'A4复印纸', warehouseId: '1930000000000000002', warehouseName: '华南中心仓', unitName: '箱', availableQty: 10, safetyStockQty: 15, suggestedPurchaseQty: 20, severity: 'MEDIUM', latestOutboundAt: '2026-06-14 08:45:00' },
    { stockId: '1940000000000000008', productId: '1920000000000000009', productCode: 'P000009', productName: '浓缩洗衣液', warehouseId: '1930000000000000003', warehouseName: '华北中心仓', unitName: '瓶', availableQty: 9, safetyStockQty: 10, suggestedPurchaseQty: 15, severity: 'MEDIUM', latestOutboundAt: '2026-06-13 17:25:00' },
    { stockId: '1940000000000000010', productId: '1920000000000000011', productCode: 'P000011', productName: '加厚垃圾袋', warehouseId: '1930000000000000004', warehouseName: '西南中心仓', unitName: '卷', availableQty: 20, safetyStockQty: 25, suggestedPurchaseQty: 30, severity: 'MEDIUM', latestOutboundAt: '2026-06-13 16:45:00' },
    { stockId: '1940000000000000012', productId: '1920000000000000012', productCode: 'P000012', productName: '无痕粘钩', warehouseId: '1930000000000000005', warehouseName: '武汉中转仓', unitName: '包', availableQty: 10, safetyStockQty: 15, suggestedPurchaseQty: 20, severity: 'MEDIUM', latestOutboundAt: '2026-06-13 15:18:00' },
  ],
  orderStages: [
  ...
  topProducts: [
    ...
    { productId: '1920000000000000007', productCode: 'P000007', productName: 'A4复印纸', salesAmount: 98400, salesQty: 220, availableQty: 10 },
    { productId: '1920000000000000002', productCode: 'P000002', productName: '速溶黑咖啡', salesAmount: 87600, salesQty: 194, availableQty: 5 },
    { productId: '1920000000000000013', productCode: 'P000013', productName: 'USB-C扩展坞', salesAmount: 75800, salesQty: 72, availableQty: 0 },
    { productId: '1920000000000000003', productCode: 'P000003', productName: '每日坚果混合装', salesAmount: 69400, salesQty: 128, availableQty: 25 },
    { productId: '1920000000000000004', productCode: 'P000004', productName: '海盐苏打饼干', salesAmount: 53600, salesQty: 104, availableQty: 19 },
    { productId: '1920000000000000005', productCode: 'P000005', productName: '中性签字笔', salesAmount: 43800, salesQty: 410, availableQty: 30.5 },
    { productId: '1920000000000000008', productCode: 'P000008', productName: '热敏标签纸', salesAmount: 31200, salesQty: 84, availableQty: 0 },
  ],
  supplierPerformance: [
    ...
    { supplierId: '1940000000000000005', supplierCode: 'S005', supplierName: '森纸纸业集团', deliveryScore: 95.8, qualityScore: 97.2, onTimeRate: 97.4 },
    { supplierId: '1940000000000000003', supplierCode: 'S003', supplierName: '谷仓食品批发', deliveryScore: 92.4, qualityScore: 95.2, onTimeRate: 94.8 },
    { supplierId: '1940000000000000002', supplierCode: 'S002', supplierName: '晨岛咖啡贸易', deliveryScore: 89.7, qualityScore: 93.4, onTimeRate: 91.1 },
    { supplierId: '1940000000000000004', supplierCode: 'S004', supplierName: '文仪办公渠道', deliveryScore: 85.4, qualityScore: 90.5, onTimeRate: 88.7 },
    { supplierId: '1940000000000000006', supplierCode: 'S006', supplierName: '拓联数码配件', deliveryScore: 78.2, qualityScore: 82.4, onTimeRate: 82.1 },
  ],
};
