...
const productSeed = [
  ['P0001', '经典原味苏打水', '1910000000000000101', '清泉', '箱', '330ml×24罐', '6901000000011', 36, 49.9, 12, 1],
  ['P0002', '速溶黑咖啡', '1910000000000000101', '晨岛', '盒', '2g×50条', '6901000000028', 42, 69, 8, 1],
  ['P0003', '每日坚果混合装', '1910000000000000102', '谷仓', '盒', '25g×30袋', '6901000000035', 68, 99, 6, 1],
  ['P0004', '海盐苏打饼干', '1910000000000000102', '谷仓', '箱', '1kg×6袋', '6901000000042', 58, 78, 5, 1],
  ['P0005', '中性签字笔', '1910000000000000104', '文仪', '盒', '0.5mm 黑色 12支', '6901000000059', 12.5, 19.9, 30, 1],
  ['P0006', '彩色便利贴', '1910000000000000104', '文仪', '本', '76mm×76mm 400张', '6901000000066', 6.8, 12, 20, 1],
  ['P0007', 'A4复印纸', '1910000000000000105', '森纸', '箱', '70g 500张×8包', '6901000000073', 92, 119, 15, 1],
  ['P0008', '热敏标签纸', '1910000000000000105', '森纸', '卷', '80mm×60mm', '6901000000080', 8.5, 15, 40, 1],
  ['P0009', '浓缩洗衣液', '1910000000000000107', '净量', '瓶', '2kg', '6901000000097', 28, 45, 10, 1],
  ['P0010', '厨房清洁湿巾', '1910000000000000107', '净量', '包', '40片', '6901000000103', 9.6, 16.9, 18, 1],
  ['P0011', '加厚垃圾袋', '1910000000000000108', '居安', '卷', '45cm×50cm 30只', '6901000000110', 5.2, 9.9, 25, 1],
  ['P0012', '无痕粘钩', '1910000000000000108', '居安', '卡', '6只装', '6901000000127', 7.8, 13.9, 15, 1],
  ['P0013', 'USB-C扩展坞', '1910000000000000110', '拓联', '个', '8合1 灰色', '6901000000134', 126, 199, 4, 0],
  ['P0014', '无线办公鼠标', '1910000000000000110', '拓联', '个', '2.4G 静音版', '6901000000141', 39, 69, 8, 0],
] as const;
